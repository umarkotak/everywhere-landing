        ...
        <footer id="contact" className="bg-white/80 backdrop-blur-lg border-t border-pink-100 pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
                    <div>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4">Everywhere.id</h3>
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mb-2">Ready to activate your campaign or event?</p>
                        <a href="mailto:business@everywhere.id" className="text-pink-500 hover:text-pink-600 transition-colors font-medium">
